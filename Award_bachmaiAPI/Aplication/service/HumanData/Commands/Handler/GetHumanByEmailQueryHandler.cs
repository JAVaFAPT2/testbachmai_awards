...
{
    public class GetHumanByEmailQueryHandler : IRequestHandler<GetPeoplesByEmailQuery, Person?>
    {
        private readonly IMongoCollection<Person> _peopleCollection;

        public GetHumanByEmailQueryHandler(IMongoCollection<Person> peopleCollection)
        {
