...
import { DepartmentleaderyearlistComponent } from './departmentleaderyearlist/departmentleaderyearlist.component';
import { DepartmentleaderyeardetailComponent } from './departmentleaderyeardetail/departmentleaderyeardetail.component';
        ...
        children: [
            {
                ...
                children: [
                    {
                        path: ':id',
                        component: DepartmentleaderyeardetailComponent,
                        resolve: {
