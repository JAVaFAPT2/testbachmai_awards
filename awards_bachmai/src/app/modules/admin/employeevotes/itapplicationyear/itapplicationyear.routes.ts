...
import { ItapplicationyearlistComponent } from './itapplicationyearlist/itapplicationyearlist.component';
import { ItapplicationyeardetailComponent } from './itapplicationyeardetail/itapplicationyeardetail.component';
...
const canDeactivateContactsDetails = (
    component: ItapplicationyeardetailComponent,
...
export default [
    {
        ...
        resolve: {
            tags: () => {
                ...
                return inject(ContactsService).getTags();
            },
        },
        children: [
            {
                ...
                resolve: {
                    contacts: () => {
                        ...
                        return inject(ContactsService).getContacts();
                    },
                    countries: () => {
                        console.log('Loading countries...');
                        return inject(ContactsService).getCountries();
                    },
                },
                children: [
                    {
